...
<%@page import="java.util.List"%> <%@page import="sample.food.FoodDTO"%> <%@
                ...
                <c:forEach var="food" items="${food}">
                  <tr>
                    ...
                    <td class="action-column">
                      <a href="fooddelete?foodID=${food.food_id}" class="delete"
                        >Delete</a
                      >
                      <a
                        href="updatefood?foodID=${food.foodname}"
                        class="update"
                        >Update</a
                      >
                    </td>
                  ...
                  <tr>
                    ...
                    <td class="action-column">
                      <a href="fooddelete?foodID=${food.food_id}" class="delete"
                        >Delete</a
                      >
                      <a href="updatefood?foodID=${food.food_id}" class="update"
                        >Update</a
                      >
                    </td>
                  </tr>
