        ...
        <section class="p-10 bg-white rounded-md shadow-md mt-20 w-1/2">
          <header class="border-b border-gray-100 px-10 flex items-center">
            ...
            <div class="text-gray-800 mx-auto pr-20 pb-4">
              <h1 class="font-bold text-5xl">Create feedback</h1>
            </div>
          </header>
    ...
    <option> Other</option>
              ...
              <div class="mb-5">
                ...
                <textarea type="text"
                  ...
                  required
                  min="0"
                  class="w-full appearance-none rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-xl font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" >
