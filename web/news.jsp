   ...
   <c:forEach items="${listN}" var="n">
            <tbody class="bg-white">
              <tr>
                ...
                <td class="px-6 py-4 text-sm leading-5 text-gray-500 whitespace-no-wrap border-b border-gray-200">
                  <img src="./news_picture/${n.photo}" width="80" height="70"/>
                </td>
...
<td class="px-2 py-4 text-sm font-medium leading-5 whitespace-no-wrap border-b border-gray-200">
    ...
    <!-- UPDATE -->                   
    <button lass="flex p-2.5 bg-green-500 rounded-xl hover:rounded-3xl hover:bg-red-500 transition-all duration-300 text-white">
    ...
    <div class="pl-4">
        <button class="flex p-2.5 bg-red-600 rounded-xl hover:rounded-3xl hover:bg-red-500 transition-all duration-300 text-white">
            <a href="deletenews?newsid=${n.news_id}" class="" onclick="return confirmDelete();">
            <i fill="none"
               viewBox="0 0 24 24"
               stroke="currentColor"
               stroke-width="2"
