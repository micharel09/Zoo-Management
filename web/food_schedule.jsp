...
import="sample.foodschedule.FoodScheduleDTO"%> <%@ page language="java"
        ...
        <table border="1">
          ...
          <c:forEach var="schedule" items="${schedulelist}">
            <tr>
              ...
              <td>
                <a href="scheduledelete?scheduleID=${schedule.schedule_id}"
                  >Delete</a
                >
              </td>
              <td>
                <a href="updateschedule?scheduleID=${schedule.schedule_id}"
                  >Update</a
                >
              </td>
              <!-- Add more columns for other animal attributes -->
