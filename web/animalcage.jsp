                ...
                <div class="my-2 flex sm:flex-row">
                  <form action="animalcagesearch" method="get">
                    <div class="block relative">
                      <span class="h-full absolute inset-y-0 left-0 flex items-center pl-4 cursor-pointer">
                      ...
                      <input type="text" id="animalcageID" name="animalcageID" placeholder="Search"
                      ...
                      <input class="text-2xl pl-2 cursor-pointer hover:text-blue-500 transition-colors duration-300"
                        type="submit" value="Search" placeholder="Search Animal by ID" />
                    </div>
                  </form>
                  <!-- end Search -->
                  <!-- Create  -->
                      ...
                      <table class="min-w-full border-collapse border border-blue-500">
                        ...
                        <c:forEach var="animalcage" items="${animalcagelist}">
                          <tbody
                            ...
                            <tr>
                              <td class="pl-10 py-4 text-2xl px-6 py-4 border-b border-gray-200 border-r">
                              ...
                              <td class="px-8 py-10 text-2xl leading-5 text-gray-500 border-b border-gray-200 border-r">
                                ${animalcage.employee_id}
                              </td>
                              <td class="py-4 text-2xl px-6 py-4 border-b border-gray-200 border-r">
                                ${animalcage.name}
                              </td>
                              <td class="py-4 text-2xl px-6 py-4 border-b border-gray-200 border-r">
                              ...
                              <td
                                ...
                                <div class="flex justify-center items-center">
                                  <!-- edit --><a href="updateanimalcage?animalcageID=${animalcage.animalcage_id}">
                                    <button
                                  ...
                                  <!-- delete -->
                                  <div class="pl-2">
                                    <a href="deleteanimalcage?animalcageID=${animalcage.animalcage_id}" class=""
                                      onclick="return confirmDelete();">
                                      <button
                                        class="flex p-2.5 bg-gray-400 rounded-xl hover:rounded-3xl hover:bg-red-500 transition-all duration-300 text-white">
                                        <i fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"
                                          class="h-4 w-4 fas fa-trash-alt"></i></button></a>
                                  </div>
                                </div>
                              </td>
                              <script>
                          ...
                          <tbody
                            ...
                            <tr>
                              ...
                              <td
                                ...
                                <div class="flex justify-center items-center">
                                  <!-- edit -->
                                  <a href="updateanimalcage?animalcageID=${animalcage.animalcage_id}">
                                    <button
                                      class="flex p-2.5 bg-gray-400 rounded-xl hover:rounded-3xl hover:bg-green-500 transition-all duration-300 text-white">
                                      <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none"
                                        viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
