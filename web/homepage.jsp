...
<html lang="en">
  ...
  <body class="block overflow-x-hidden mx-auto bg-gray-300">
    ...
    <!--LOGO HERE-->
<!--LOGO HERE-->
<div style="z-index: 99; position: relative; top: 58px; right:20px">
  <a href="homepage"><img class="fsp-image" src="/img/FSP.png" alt="logo"/></a>
</div>
        ...
        <div class="h-[200px] w-[300px] lg:h-auto  flex-none bg-cover rounded-t lg:rounded-t-none lg:rounded-l text-center overflow-hidden" style="background-image: url('./news_picture/${n.photo}')" title="Woman holding a mug"></div>
          <div class="border-r border-b border-l border-gray-400 lg:border-l-0 lg:border-t lg:border-gray-400 bg-white rounded-b lg:rounded-b-none lg:rounded-r p-4 flex flex-col justify-between leading-normal">
              <div class="mb-8">
                ...
                <div class="flex">
                <p class="text-gray-700 text-base line-clamp-2 w-32 text-left text-light capitalize">${n.content}</p>
              </div></div>
