...
@WebServlet(name = "Importexcel_FeedingSchedule_Controller", urlPatterns = {"/importexcel_feedingSchedule_controller"})
public class Importexcel_FeedingSchedule_Controller extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        request.getRequestDispatcher("Trainer_Search_Cage_Controller").forward(request, response);
    }
