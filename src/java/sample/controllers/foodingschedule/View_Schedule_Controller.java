 ...
 * @author ACER
 */
@WebServlet(name = "View_Schedule_Controller", urlPatterns = {"/View_Schedule_Controller"})
public class View_Schedule_Controller extends HttpServlet {

    private static final String ERROR = "Schedule_Select_Cage.jsp";
    private static final String SUCCESS = "Schedule_Animal_Cage.jsp";
