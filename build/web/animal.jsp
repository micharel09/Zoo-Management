                    ...
                    <div class="my-2 flex sm:flex-row">
                      <form action="animalsearch" method="get">
                        <div class="block relative">
                          ...
                          <input type="text" id="animalID" name="animalID" placeholder="Search Animal by ID"
                          ...
                          <table class="min-w-full border-collapse border border-blue-500">
                            ...
                            <c:forEach var="animal" items="${animallist}">
                              <tbody
                                ...
                                <tr>
                                  <td class="text-blue-500 pl-10 text-2xl px-6 border-b border-gray-200 border-r">
                                    #${animal.animal_id}
                                  </td>
                                  ...
                                  <td class="text-2xl px-6 border-b border-gray-200 border-r">
                                    ${animal.name}
                                  </td>
                                    ...
                                    <div class="flex justify-center items-center">
                                      ...
                                      <div class="pl-2">
                                        <button
                                          ...
                                          <a href="animaldelete?animalID=${animal.animal_id}" class=""
                                            onclick="return confirmDelete();">
                                            <i fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"
                                              class="h-4 w-4 fas fa-trash-alt"></i>
                                          </a>
                                        </button>
                                      </div>
                                    </div>
