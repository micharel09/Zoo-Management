    ...
    <ol class="inline-flex items-center space-x-1 md:space-x-3">
        ...
        <li aria-current="page">
            <div class="flex items-center">
                ...
                <span class="text-gray-400 ml-1 md:ml-2 text-sm font-medium dark:text-gray-500">Food Schedule</span>
            </div>
        </li>
    </ol>
</nav>
<section class="py-10 px-6">
    <h1>Food Schedule List</h1>
    <table class="w-full table-div">
        ...
        <c:forEach var="foodschedule" items="${foodschedule}">
            <tr>
                <td>${foodschedule.schedule_id}</td>
                <td>${foodschedule.time}</td>
                <td>${foodschedule.animalcage_id}</td>
                <td>${foodschedule.food_id}</td>
                <td class="action-column">
                    <a href="DeleteFoodScheduleController?animalID=${foodschedule.schedule_id}" class="delete">Delete</a>
                    <a href="UpdateFoodScheduleController?animalID=${foodschdule.foodname}" class="update">Update</a>
                </td>
            </tr>
        </c:forEach>
    </table>
    <form action="FoodScheduleController" method="get">
        <label for="schedule_id">Search Animal by schedule:</label>
